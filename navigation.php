...
{
	protected static $description = 'Navigation-Plugin. Navigate from A to B';
	protected static $helpMessage = "'navigation from <START> to <DESTINATION>': Returns a map, containing the route from the start-point to the destination\n
